...
class Calm4 extends StatefulWidget {
  const Calm4({super.key});

  @override
  State<Calm4> createState() => _Calm4State();
}

class _Calm4State extends State<Calm4> {
  ...
  void playSong(int index) async {
    if (index >= 0 && index < playlist.length) {
      ...
      await player.setSource(AssetSource(playlist[currentSongIndex]));
      await player.resume(); // Start playing the song
      duration = await player.getDuration();
      setState(() {
